...
$(document).ready(function () {
  ...
  function validateName() {
    ...
    // input validation no more than 3 identical characters in a row
      ...
      $("#name").removeClass("invalid");
      $(".valid_info_name")
        .text("The name entered is invalid. Too many identical characters")
        .css("color", "red");
      $("#name").addClass("invalid");
      nameVal = false;
      return false;
    ...
    // checking for valid characters
      ...
      $("#name").removeClass("valid");
      $("#name").removeClass("invalid");
      $(".valid_info_name").text("").css("color", "green");
      $("#name").addClass("valid");
      // check first character
          ...
          // check duplicates
            ...
            if (emailRegEx.test($("#email").val())) {
              ...
              // check duplicates
                ...
                $("#email").removeClass("valid");
                $("#email").removeClass("invalid");
                $(".valid_info_email").text("").css("color", "green");
  ...
  function validateTextarea() {
    ...
    // if the field contains more than 500 characters
      ...
      $("#message").removeClass("valid");
      $("#message").removeClass("invalid");
      $(".valid_info_message").text("").css("color", "green");
